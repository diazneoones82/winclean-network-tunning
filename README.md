...
- Optional startup tray mode runs the sign-in cleanup minimized and only shows a notification after the startup run completes.
- Duplicate app sessions are blocked so startup and manual launch paths do not open two copies.
